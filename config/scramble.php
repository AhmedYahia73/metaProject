...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Meta Restaurant Platform & WhatsApp Bot SaaS API Documentation. Use Bearer Token for protected routes.',
    ],

    'ui' => [
        'title' => 'Meta Restaurant API Docs',
    ],
    ...
    'security_strategy' => [
        ...
        [
            ...
            'scheme' => \Dedoc\Scramble\Support\Generator\SecurityScheme::http('bearer')
                ->setDescription('Enter your Sanctum Bearer token'),
        ],
    ],
];
